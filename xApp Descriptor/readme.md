...
### 2.1 xapp_name (Mandatory)
  ...
  *	Example: </br>
    ...
    ![image]([https://github.com/llab305/O-RAN/blob/main/xApp%20Descriptor/Figure/Figure%202.1-1.png](https://github.com/llab305/O-RAN/blob/main/xApp%20Descriptor/Figure/Figure%202.1-1.png))
    
    <p align="center"> Figure 2.1-2 xapp_name - if "< type >" equals "handover" - example </p>
    ![image]([https://github.com/llab305/O-RAN/blob/main/xApp%20Descriptor/Figure/Figure%202.1-2.png](https://github.com/llab305/O-RAN/blob/main/xApp%20Descriptor/Figure/Figure%202.1-2.png))
